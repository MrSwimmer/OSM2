...
public class SucEnter extends AppCompatActivity {
    ...
    public void upload() {
        final Uri file = Uri.fromFile(new File(Environment.getDataDirectory(), "//data//" + "com.bignerdranch.android.OSMpro"
    ...
    public void download() throws IOException {
        Toast.makeText(SucEnter.this, "Идет загрузка", Toast.LENGTH_SHORT).show();
        final File localFile = new File(Environment.getDataDirectory(), "//data//" + "com.bignerdranch.android.OSMpro"
                + "//databases//" + "noteBase.db");
