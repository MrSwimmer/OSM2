...
import pro.bignerdranch.android.osmpro.NoteLab;
import pro.bignerdranch.android.osmpro.NotePagerActivity;


import java.util.UUID;

//import com.bignerdranch.android.OSMpro.puls.Browser;
...
public class Pulsometro extends Activity {
    ...
    private static PreviewCallback previewCallback = new PreviewCallback() {
        ...
        public void onPreviewFrame(byte[] data, Camera cam) {
            ...
            MyVars.TYPE newType = MyVars.statusBatimento;
            if (imgAvg < changeAVG) {
                newType = MyVars.TYPE.beatON;
                if (newType != MyVars.statusBatimento) {
                    MyVars.beats++;
                }
            } else if (imgAvg > changeAVG) {
                newType = MyVars.TYPE.beatOFF;
            }
